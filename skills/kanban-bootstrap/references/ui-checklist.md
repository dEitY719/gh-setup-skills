...
emits this list with host-aware deep-links and the dEitY719/dotfiles#289-aligned
...
| 3 | `Pull request linked to issue` | **DISABLE** (dEitY719/dotfiles#289) | Issues do NOT visit `In review` |
...
## Why workflow #3 is disabled (dEitY719/dotfiles#289)
...
issue on whichever server that points at (dEitY719/dotfiles#1403 / dEitY719/dotfiles#1407).
